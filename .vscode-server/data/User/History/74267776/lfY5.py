...
def pick_restaurant():
    ...
    restaurant = json.loads(responce.text)['results']['shop']
    print(result)

    restaurant_datas.append(restaurant['name'], restaurant['address'], restaurant['budget']['name'], restaurant['genre']['name'], restaurant['urls'])
